...
DATASETS_NAMES = ['imagenet', 'cifar10','mnist','tiny_imagenet']
...
def load_data(dataset, data_dir, batch_size, workers, valid_size=0.1, deterministic=False):
    ...
    if dataset == 'tiny_imagenet':
        return tiny_imagenet_load_data(data_dir, batch_size, workers, valid_size=valid_size, deterministic=deterministic)    
...
def tiny_imagenet_load_data(data_dir, batch_size, num_workers, valid_size=0.1, deterministic=False):
    """Load the ImageNet dataset.
